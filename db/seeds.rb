...
Meetup.create(name: 'Cat People', description: 'A group for cat people.', location: 'New York City', user_id: 1)
...
Member.create(meetup_id: 2, user_id: 2)
Member.create(meetup_id: 3, user_id: 1)
Member.create(meetup_id: 4, user_id: 2)
